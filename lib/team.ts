...
export const teamMembers: TeamMember[] = [
  {
    ...
    bio: `John Humphrey is a serial entrepreneur who has built his career on transforming how businesses leverage data to drive growth. As Founder and CEO of CoPoint Data, John helps organizations unlock the power of their data through sophisticated data analytics and actionable intelligence.

    At CoPoint Data, John has pioneered innovative approaches to rapid application development around data, analytics, and machine learning, enabling companies to identify high-value insights that would otherwise remain hidden. The company's proprietary processes transform raw data into strategic insights, helping clients make data-informed decisions that accelerate revenue growth, cost savings and market expansion.
    
    Prior to founding CoPoint Data, John created Connect for Life, a book, methodology, and coaching firm that helped knowledge workers build their personal brands in the marketplace. This venture, which included the book and the ConnectPoints software, provided the foundation for IT consulting firms to grow their businesses through connecting, creating, and engaging in the marketplace. At CoPoint Data, the firm is leveraging these concepts and does not employ a direct sales organization.
  ...
  },
  {
    ...
    bio: `As President and COO of CoPoint Data, Dipesh Patel brings a combination of strategic vision and hands-on technology expertise honed over two decades in management consulting. He began his career at Deloitte Consulting, and since served in leadership positions Pariveda Solutions and North Highland before launching his previous firm, Solvegy.
  ...
  },
  {
    ...
    bio: `Robert is a technology and AI leader with over 20 years of experience architecting transformative solutions for some of the world's largest companies. His expertise spans the full AI lifecycle – from use case identification and architecture to enterprise-wide implementation – with a proven track record of delivering measurable business outcomes through strategic digital initiatives.

    Combining deep technical knowledge with strategic vision, Robert specializes in four core domains: AI/Technology Strategy, Change Management, Data Analytics, and Digital Integration. His human-centric approach ensures technology solutions not only meet technical requirements but drive meaningful adoption and lasting cultural transformation across organizations and for their customers.
  ...
  },
  {
    ...
    bio: `In today's data-driven business landscape, Saurabh Singh Teotia believes that the key to organizational success lies in transforming raw data into actionable intelligence. With over 20+ years of experience in data analysis and management, Saurabh has established himself as a leader who bridges the gap between complex data systems and strategic business decisions.

    Saurabh is a seasoned data analytics professional who has built his career transforming how organizations leverage their data assets. Currently serving as Associate Director at Copoint Data, he focuses on providing strategic business consulting and implementing data-driven solutions that enhance operational efficiency across diverse geographies.
    
    Prior to his current role, Saurabh spent 15 years at Midland Credit Management as AVP - Data Analysis, where he led a team of 25+ members and revolutionized the company's approach to data management and analysis. His expertise in creating sophisticated dashboards, developing databases, and aligning analytics with strategic business initiatives has been instrumental in driving operational excellence across US, UK, and Australian markets.
    
    Saurabh's technical prowess and leadership in data analytics have earned him prestigious recognition, including being named a "Microsoft Most Valued Professional in Excel" by Microsoft in 2009 and receiving the Gold Award at Midland Credit Management in 2022. His approach combines technical expertise with business acumen, focusing on transforming complex data into clear, actionable insights that drive strategic decision-making.
  ...
  },
  {
    ...
    bio: `Supporting organizations and tech experts with recruitment and behavioral training to accelerate their career aspirations | MBTI practitioner | certified PMP | best in - campus recruiter award eed by word | coffee evangelist with over 20 years of transformative experience in learning & development and human resources, Neeraj Shridhar has pioneered innovative talent development strategies that have reshaped organizational learning cultures.
  ...
  },
  {
    name: "Reva Bhatia",
    role: "Data Scientist",
    bio: `Accomplished executive and dynamic data scientist with over 20 years of entrepreneurial and consulting experience, including significant roles with Big 4 firms, specializing in data processing, statistical modelling, data science, machine learning, predictive analytics, and data visualization. Adept at navigating complex global environments, fostering strong stakeholder relationships, and aligning business objectives with market opportunities to achieve significant results. 
