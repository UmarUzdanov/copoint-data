...
import { ArrowRight, Brain, ChevronRight, Database } from "lucide-react"
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        {/* All AI, All Data, All of the Time Section */}
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-light text-navy mb-4">All AI, All Data, All of the Time</h2>
              <div className="section-divider"></div>
              <p className="text-black max-w-3xl mx-auto mt-6">
                At CoPoint Data, we leverage the full power of AI to assist in your transformation of data and
                operations to achieve measurable results.
              </p>
            </div>
            ...
            {/* Ongoing Support - Full width box */}
            <div className="bg-gray-bg p-8 rounded-lg transition-all hover:shadow-lg hover:translate-y-[-5px]">
              <div className="bg-carolina-blue/20 p-4 rounded-full w-16 h-16 flex items-center justify-center mb-6">
                <svg
                  width="32"
              ...
              <h3 className="text-xl font-semibold mb-4 text-basin-slate">Ongoing Support</h3>
              <p className="text-black mb-6">
                Our global footprint allows us to deliver ongoing support solutions that follow the sun. We provide
                continuous monitoring, optimization, and enhancement of your AI and data solutions to ensure they
              ...
              <ul className="space-y-2 mb-6">
                ...
                <li className="flex items-start">
                  <ChevronRight className="h-5 w-5 text-carolina-blue shrink-0 mt-0.5" />
                  <span>Continuous improvement and enhancement</span>
                </li>
              </ul>
              <Link
                href="/contact"
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="relative">
                <div className="bg-carolina-blue text-navy p-6 rounded-lg h-full transition-all hover:shadow-lg">
                  ...
                  <p className="text-black text-center">
                    We work with you to define the business outcomes you are trying to drive across your business
                    whether AI driven development or data analytics.
                  </p>
                </div>
              ...
              <div className="relative">
                <div className="bg-carolina-blue text-navy p-6 rounded-lg h-full transition-all hover:shadow-lg">
                  ...
                  <p className="text-black text-center">
                    Our expert teams build and deploy custom AI and data solutions tailored to your specific business
                    needs.
                  </p>
                </div>
                <div className="hidden md:block absolute -right-3 top-1/2 transform -translate-y-1/2 z-10">
              ...
              <div className="relative">
                <div className="bg-carolina-blue text-navy p-6 rounded-lg h-full transition-all hover:shadow-lg">
                  ...
                  <p className="text-black text-center">
                    We focus on your team being self-sufficient as we transition off the team.
                  </p>
                </div>
                <div className="hidden md:block absolute -right-3 top-1/2 transform -translate-y-1/2 z-10">
                  <ChevronRight className="h-6 w-6 text-carolina-blue" />
              ...
              <div>
                <div className="bg-carolina-blue text-navy p-6 rounded-lg h-full transition-all hover:shadow-lg">
                  ...
                  <p className="text-black text-center">
                    Our global footprint allows us to deliver ongoing support solutions that follow the sun.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-carolina-blue">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-light mb-4 text-navy">
              Ready to transform your AI and Data strategy?
            </h2>
            <p className="text-black mb-8 max-w-2xl mx-auto">
              Let's discuss how CoPoint Data can help you leverage the full power of your AI and Data ecosystem.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
