    ...
    <>
      {formStatus.isSubmitted ? (
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          {formStatus.error && (
            <div className="bg-red-50 border border-red-200 text-red-800 p-4 rounded-lg">{formStatus.error}</div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full h-[48px] px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-navy border border-gray-300"
                required
              />
            </div>
            <div>
          ...
          <Button
            type="submit"
            className="bg-navy text-white hover:bg-navy/90 h-[48px] text-base px-6 w-full md:w-auto"
            ...
            <div className="max-w-5xl mx-auto">
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <div>
                  ...
                  <p className="text-black mb-8">We would love to hear from you. Here is how you can reach us.</p>
                  <div className="space-y-6">
                    <div className="flex items-start">
                      <div className="bg-carolina-blue h-10 w-10 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                        <MapPin className="h-5 w-5 text-white" />
                      </div>
                      <div className="ml-4">
                        <h3 className="text-lg font-semibold text-basin-slate">Our Offices</h3>
                    ...
                    <div className="flex space-x-4">
                      ...
                      >
                        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                          <path
                            fillRule="evenodd"
                            d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427a4.902 4.902 0 011.772 1.153a4.902 4.902 0 011.153 1.772c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.63c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153a4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"
                          />
                        </svg>
                      </a>
                      <a
                      ...
                      >
                        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                          <path
                            fillRule="evenodd"
                            d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772a4.902 4.902 0 01-1.772 1.153c-.636-.247-1.363-.416-2.427-.465C8.901 2.013 9.256 2 11.685 2h.63zm-.081 1.802h-.468c-2.456 0-2.784.011-3.807.058-.975.045-1.504.207-1.857.344-.467.182-.8.398-1.15.748-.35.35-.566.683-.748 1.15-.137.353-.3.882-.344 1.857-.048 1.055-.058 1.37-.058 4.041v.468c0 2.456.011 2.784.058 3.807.045.975.207 1.504.344 1.857.182.466.399.8.748 1.15.35.35.683.566 1.15.748.353.137.882.3 1.857.344 1.054.048 1.37.058 4.041.058h.08c2.597 0 2.917-.01 3.96-.058.976-.045 1.505-.207 1.858-.344.466-.182.8-.398 1.15-.748.35-.35.566-.683.748-1.15.137-.353.3-.882.344-1.857.048-1.055.058-1.37.058-4.041v-.08c0-2.597-.01-2.917-.058-3.96-.045-.976-.207-1.505-.344-1.858a3.097 3.097 0 00-.748-1.15 3.098 3.098 0 00-1.15-.748c-.353-.137-.882-.3-1.857-.344-1.023-.047-1.351-.058-3.807-.058zM12 6.865a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 1.802a3.333 3.333 0 100 6.666 3.333 3.333 0 000-6.666zm5.338-3.205a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z"
                            clipRule="evenodd"
                          />
                        </svg>
                      </a>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="h-96 rounded-lg overflow-hidden">
                {/* Map component with Dallas coordinates */}
                <div className="w-full h-full" id="map">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3355.4234567890123!2d-96.7969879!3d32.7766642!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x864e991b9685b2e9%3A0x9b0b0b0b0b0b0b0b!2s5646%20Milton%20St%2C%20Dallas%2C%20TX%2075206!5e0!3m2!1sen!2sus!4v1716811221148!5m2!1sen!2sus"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    allowFullScreen
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="border border-gray-200 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-basin-slate mb-3">
                    What services does CoPoint Data offer?
                  </h3>
                  <p className="text-black">
                    CoPoint Data specializes in AI and data solutions, offering services including data strategy,
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-black">
                    Project timelines vary based on scope and complexity. A data strategy engagement typically takes 4-6
                    weeks, while implementation projects can range from 3-9 months depending on requirements and
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-black">
                    Yes, we work with organizations of all sizes, from mid-market companies to Fortune 500 enterprises.
                    Our solutions are scalable and tailored to meet the specific needs and budget of each client.
                  </p>
                </div>

                <div className="border border-gray-200 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-basin-slate mb-3">
                    How do we get started working with CoPoint Data?
                  </h3>
                  <p className="text-black">
