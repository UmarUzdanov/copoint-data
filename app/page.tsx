      ...
      <main className="flex-1">
        ...
        <section className="relative h-[50vh] flex items-center">
          <div className="absolute inset-0 z-0">
            <Image src="/home_hero.jpg" alt="Microsoft Tech Dashboard" fill className="object-cover" priority />
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-white text-lg mb-8">
                CoPoint Data helps organizations drive business outcomes leveraging data and leading AI tools.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-light text-navy mb-4">
                We put <span className="font-semibold text-basin-slate">human intelligence</span> in AI
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-sm  hover:shadow-lg hover:translate-y-[-5px]">
                <h3 className="text-xl font-semibold mb-4 text-basin-slate">
                  Do you want to implement AI but don't have a comprehensive strategy to do it?
                </h3>
                <p className="text-black">
                  At CoPoint Data, we help you develop a strategic approach to AI implementations that aligns with your
                  business goals and delivers measurable results.
                </p>
              </div>
              <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-lg hover:translate-y-[-5px]">
                <h3 className="text-xl font-semibold mb-4 text-basin-slate">
                  Do you want to know how to leverage AI driven development and AI driven analytics on the Microsoft
                  stack?
                </h3>
                <p className="text-black">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              <div className="relative">
                <div className="bg-carolina-blue text-navy p-6 rounded-lg h-full hover:shadow-lg hover:-translate-y-1 cursor-pointer transition-all duration-300">
                  ...
                  <p className="text-black text-center">
                    Our experts understand the variety of AI tools and can go deep in any of the development or data
                    stacks to deliver results and level up your team.
                  </p>
                </div>
                <div className="hidden md:block absolute -right-3 top-1/2 transform -translate-y-1/2 z-10">
                  <ChevronRight className="h-6 w-6 text-carolina-blue" />
        ...
        <section className="py-16 bg-navy">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-white max-w-3xl mx-auto mt-6">
              We transform businesses through AI driven development and data insights to create lasting outcomes.
            </p>
          </div>
        </section>
        {/* Core Values Section */}
        ...
        <section className="py-16 bg-carolina-blue">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-black mb-8 max-w-2xl mx-auto">
              Let's talk about how CoPoint Data can help you level up your data and AI resources.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <Button
                  className="bg-white text-navy hover:bg-navy hover:text-white transition-colors duration-300"
                  aria-label="Contact Us"
                >
                  Contact Us
                </Button>
